 ...
 * Use the {@link ScannerFragmentQReader#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ScannerFragmentQReader extends Fragment {
    ...
    private ScannerFragmentQReader fragment = this;
    private boolean tabSelected = false;
    private View layShowOk;

    private SurfaceView mySurfaceView;
    private QREader qrEader;
    private FrameLayout parentCamera;

    public ScannerFragmentQReader() {
    ...
    public static ScannerFragmentQReader newInstance() {
        ScannerFragmentQReader fragment = new ScannerFragmentQReader();
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_scan_qreader, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        parentCamera = view.findViewById(R.id.parentCamera);
        ...
        layBtnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (layChekinUser.getVisibility() == View.VISIBLE) {
                    ...
                    mySurfaceView.refreshDrawableState();
        ...
        ivFlipCam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (qrEader != null) {
                    ...
                    parentCamera.removeView(mySurfaceView);
                    parentCamera.addView(mySurfaceView);
...
//        }
    ...
    public void showOkView() {
        ...
        Blurry.with(getContext()).
                ...
                .animate()
                .async()
                .capture(scannerView).into(ivTransparent);
    ...
    public void createQRDetector() {
        ...
        }).facing(camera == 0 ? QREader.BACK_CAM : QREader.FRONT_CAM)
    ...
    private void afterScanCode(String code) {
        if (!tabSelected) {
            Timber.d("Not in tub");
            return;
        }
        ...
        if (MainActivity.lessonsResponce != null && MainActivity.location != null && compositeDisposable != null) {
            ...
            compositeDisposable.add(
                    ProviderModule
                            .getUserProvider()
                            .getUserProfile(code, String.valueOf(MainActivity.lessonsResponce.getCurrent().getId()))
                                                            ...
                                                            layBtnChekin.setOnClickListener(
                                                                    v -> {
                                                                        if (checkLocation(returnUser) && CheckStartTime(returnUser)) {
                                                                            compositeDisposable.add(ProviderModule.getUserProvider().checkin(MainActivity.location.getLatitude(), MainActivity.location.getLongitude(), code, String.valueOf(MainActivity.lessonsResponce.getCurrent().getId()))
                                                                                    .compose(RxUtils.ioToMainTransformerSingle())
                                                                                    .subscribe(done12 -> {
...
//                                                                        }
                                                            layBtnChekin.setOnClickListener(v -> {
                                                                if (checkLocation(returnUser) && CheckStartTime(returnUser)) {
                                                                    compositeDisposable.add(ProviderModule.getUserProvider().checkOut(code, String.valueOf(MainActivity.lessonsResponce.getCurrent().getId()))
                                                                            .compose(RxUtils.ioToMainTransformerSingle())
                                                                            .subscribe(done1 -> {
